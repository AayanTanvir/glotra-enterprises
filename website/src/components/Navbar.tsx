...
export default function Navbar() {
    return (
        <div className='w-full h-fit fixed top-0 left-0 z-50 p-4 bg-background flex justify-evenly items-center'>
            ...
            <nav className='w-fit h-full flex justify-between items-center gap-3 sm:gap-4'>
                <Navlink to="/about" className='text-xs sm:text-base'>About Us</Navlink>
                <Navlink to="/services" className='text-xs sm:text-base'>Services</Navlink>
                <Navlink to="/contact" className='text-xs sm:text-base'>Contact Us</Navlink>
            </nav>
        </div>
    )
}