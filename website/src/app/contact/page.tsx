...
const ContactUs = () => {
    return (
        <div className="w-full min-h-screen flex flex-col md:flex-row justify-center items-center mt-16">
            ...
            <div className="w-[80%] min-h-[15rem] border-[1px] border-foreground/30 rounded mb-12 flex flex-col justify-center items-start p-8 gap-6">
            ...
            <div className="w-[80%] min-h-[18rem] border-[1px] border-foreground/30 rounded">
                {/* add contact form to get emails */}
            </div>
        </div>
    )
}
